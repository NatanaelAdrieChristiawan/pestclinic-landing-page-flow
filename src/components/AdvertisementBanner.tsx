      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <button className="bg-background text-primary hover:bg-secondary px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center">
                <PhoneCall className="h-5 w-5 mr-2" />
                +65 1234 5678
              </button>
              <button className="border-2 border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-primary px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300">
                WhatsApp Us
              </button>
            </motion.div>
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                className="absolute -top-4 -right-4 bg-background text-primary p-4 rounded-full shadow-xl animate-bounce"
              >
